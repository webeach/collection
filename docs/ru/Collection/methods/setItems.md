...
- **Возвращает** — количество успешно добавленных элементов (может быть `0`, если передан пустой массив). Возвращает `0` без события `update`, если хук `clear:before` отменил операцию.
